...
class UserLocationAndBusStopMap extends StatefulWidget {
  ...
  final bool showCountOnly; // Add this parameter to toggle the display

  const UserLocationAndBusStopMap({
    super.key,
    this.onMapReady,
    this.busStops,
  ...
  @override
  State<UserLocationAndBusStopMap> createState() =>
      _UserLocationAndBusStopMapState();
}

class _UserLocationAndBusStopMapState extends State<UserLocationAndBusStopMap> {
  ...
  @override
  void didUpdateWidget(UserLocationAndBusStopMap oldWidget) {
