...
//
//   // Valid states for rideStatus
//   static const List<String> validStatuses = ['idle', 'inProgress', 'completed'];
//
//   /// Public getter for rideStatus
//   String get rideStatus => _rideStatus;
//
//   /// Public setter for rideStatus that enforces the valid values
...
//     required String rideStatus, // Pass in as normal string
//     required this.busId,
...
//     DateTime? createdAt,
//     this.endedAt,
//   })  : _rideStatus = validStatuses.contains(rideStatus) ? rideStatus : 'idle',
...
//     final rawStatus = map['ride_status'] ?? '';
//     // Fallback to 'idle' if the status isn't valid
//     final status = validStatuses.contains(rawStatus) ? rawStatus : 'idle';
//
//     return RideModel(
//       rideId: map['auto_id'] ?? '',
//       routeId: map['route_id'] ?? '',
//       rideStatus: status,           // This uses the setter and enforces validity
//       busId: map['bus_id'] ?? '',
...
// class RideModel {
//   @HiveField(0)
//   final String? rideId; // Nullable
//
//   @HiveField(1)
//   final String routeId;
//
//   @HiveField(2)
//   final String? rideStatus; // Just a simple string, no validation
//
//   @HiveField(3)
//   final String busId;
//
...
//       DateTime.parse(map['created_at'] ?? DateTime.now().toIso8601String()),
//       endedAt:
//       map['ended_at'] != null ? DateTime.parse(map['ended_at']) : null,
//     );
//   }
// }
