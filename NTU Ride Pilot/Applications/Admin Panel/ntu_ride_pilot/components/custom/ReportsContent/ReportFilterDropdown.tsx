...
const ReportFilterDropdown: React.FC<ReportFilterDropdownProps> = ({ value, onChange }) => {
  return (
    <div className="relative w-auto">
      ...
      >
        <option value="active">One Day</option>
        <option value="all">One Week</option>
        <option value="suspended">One Month</option>
      </select>
